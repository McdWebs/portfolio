    ...
    >
      ...
      <Box
        sx={{
          ...
          width: '100%',
          height: '100%',
          background: 'radial-gradient(circle at 50% 50%, rgba(168, 168, 168, 0.03) 0%, transparent 70%)',
          pointerEvents: 'none',
        }}
      />
      ...
      <Box
        sx={{
          ...
          width: '100%',
          height: '1px',
          background: 'linear-gradient(90deg, transparent, rgba(168, 168, 168, 0.2), transparent)',
      ...
      <Box
        sx={{
          ...
          width: '1px',
          height: '100%',
          background: 'linear-gradient(180deg, transparent, rgba(168, 168, 168, 0.2), transparent)',
      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          <motion.div variants={itemVariants} style={{ width: '100%', marginTop: '1rem' }}>
            <Box
              sx={{
                width: '120px',
                height: '1px',
          ...
          <motion.div variants={itemVariants} style={{ width: '100%', maxWidth: '600px' }}>
            ...
            >
              ...
              Specialized in creating sophisticated, modern websites that resonate
